...
begin
  ...
  begin
    perform public.register_account('ZZT1','Angriper','Deltid','#000000','hack1234', inv);
  ...
  perform public.register_account('ZZT2','Vanlig Ansatt','Deltid','#004595','test1234', inv);
  ...
  perform public.register_account('ZZT3','Ny Ansatt','Deltid','#004595','test1234', inv);
